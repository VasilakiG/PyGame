...
def main():
    ...
    #-----------овде има промена---------------------------------
    random_steps = random.randint(1, 100)
    mainBoard, solutionSequence = generateNewPuzzle(random_steps)
    #------------------------------------------------------------
    playerMoves = 0
    #------------------------------------------------------------
    ...
    while True: #main game loop
        ...
        if mainBoard == SOLVED_BOARD:
            #-----------овде има промена---------------------------------
            msg = f'Solved in {playerMoves} moves. Computer took {len(solutionSequence)} moves.'
            #------------------------------------------------------------
            ...
            if event.type == MOUSEBUTTONUP:
                ...
                if (spotX, spotY) == (None, None):
                    ...
                    if RESET_RECTANGLE.collidepoint(event.pos):
                        ...
                        #-----------овде има промена---------------------------------
                        mainBoard, solutionSequence = generateNewPuzzle(random.randint(1, 100))
                        playerMoves = 0
                        #------------------------------------------------------------
                        allMoves = []
