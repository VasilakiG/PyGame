...
#--------------ADDED CODE--------------------
YELLOW_APPLE_DURATION = 300  # 300 frames
...
def runGame():
    ...
    while True: # main game loop
        ...
        #--------------ADDED CODE--------------------------------
        # Check if the yellow apple is on the screen and decrement its timer
        if yellowAppleOnScreen:
            yellowAppleTimer -= 1
        ...
        # Handle eating the yellow apple
        if wormCoords[HEAD]['x'] == yellowApple['x'] and wormCoords[HEAD]['y'] == yellowApple['y']:
            yellowAppleOnScreen = False
            if len(wormCoords) > 2:
                del wormCoords[-1]  # Remove worm's tail segment  # Remove worm's tail segment
        #-------------------------------------------
        ...
        drawApple(apple)
        #--------------MODIFIED CODE-----------------
        drawScore(redApplesEaten)
        #--------------------------------------------
        
        # Draw the yellow apple if it's on the screen
        if yellowAppleOnScreen:
...
def drawYellowApple(coord):
    ...
    pygame.draw.rect(DISPLAYSURF, (255, 255, 0), yellowAppleRect)  # Yellow color
